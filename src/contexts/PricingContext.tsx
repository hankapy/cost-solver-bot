...
const DEFAULT_SETTINGS: PricingSettings = {
  ...
  providerHumanTiers: [
    ...
    { queryLimit: 100, basePrice: 175 },
    { queryLimit: 150, basePrice: 200 },
    { queryLimit: 300, basePrice: 225 },
    { queryLimit: 500, basePrice: 250 },
  ],
  ...
  providerBotTiers: [
    ...
    { queryLimit: 150, price: 0, systemCosts: 125 },
    { queryLimit: 300, price: 0, systemCosts: 150 },
    { queryLimit: 500, price: 0, systemCosts: 175 },
  ],
  ...
  botTiers: [
    ...
    { queryLimit: 150, price: 250, systemCosts: 150 },
    { queryLimit: 300, price: 350, systemCosts: 200 },
    { queryLimit: 500, price: 500, systemCosts: 200 },
  ],
  botGrowth: [
