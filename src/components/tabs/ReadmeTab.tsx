        ...
        <CardContent className="space-y-3 text-sm text-muted-foreground">
          ...
          <div className="space-y-3 pl-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside pl-4">
                <li>Aloitusmaksu (kertaluonteinen)</li>
                <li>Portaistettu hinnoittelu (hinta ja järjestelmäkulut eri kyselymäärille)</li>
              </ul>
            </div>
            <div>
              <p className="font-semibold">4. Botin osuuden kehitys:</p>
              <ul className="list-disc list-inside pl-4">
                <li>Kuukausitason kehitys (kk 1-12): montako % botti hoitaa kunakin kuukautena</li>
                <li>Vuositason kehitys (vuodet 0-3): montako % botti hoitaa kussakin vuodessa</li>
              </ul>
            </div>
          </div>
          <p className="pt-2 border-t"><strong>Miksi aloittaa täältä?</strong></p>
          <p>
            Ennen kuin tutustut muihin välilehteihin, kannattaa käydä Asetukset läpi ja säätää luvut vastaamaan omaa tilannettasi. Näin kaikki laskelmat ovat heti oikein!
          </p>
        </CardContent>
      </Card>
